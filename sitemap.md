...
- [How we verify tracker](https://2389-research.github.io/tracker/verify.html) — How tracker proves its engine doesn&#39;t silently drift: golden-trace conformance versioned in lockstep with every tag, …

- [Models & Providers](https://2389-research.github.io/tracker/models.html) — Every LLM model and provider Tracker can price and route — Anthropic, OpenAI, Google Gemini, and OpenAI-compatible …
