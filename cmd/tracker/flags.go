...
func newRunFlagSet(progName string, cfg *runConfig) *flag.FlagSet {
	...
	fs.StringVar(&cfg.gatewayURL, "gateway-url", "", "Cloudflare AI Gateway root URL (e.g., https://gateway.ai.cloudflare.com/v1/account/gateway)")
	return fs
}
...
func printUsage(w io.Writer) {
	...
	fmt.Fprintf(w, "  --gateway-url string      Cloudflare AI Gateway root URL (synthesizes provider-specific URLs)\n")
