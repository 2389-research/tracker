...
## WORKING DIRECTORY
All your work MUST happen inside `.cookoff/opus/` relative to the project root.
1. mkdir -p .cookoff/opus
2. Copy the project source files (not .git, not .tracker, not .cookoff) into .cookoff/opus/ if not already there
3. Do all implementation work inside .cookoff/opus/
...
- Run the test suite inside .cookoff/opus/. Read output. Check exit codes. Count failures. THEN claim.
