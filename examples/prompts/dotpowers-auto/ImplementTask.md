...
## Autonomous Mode
You are running fully headless. If you encounter ambiguity in the task spec, use your best judgment and proceed. Do NOT write questions to implementer-status.txt — just implement.
