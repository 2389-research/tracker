...
echo .ai/build/no-tests-ok > "$WORK/.ai/milestones/opt-outs.snapshot"
echo TestParse > "$WORK/.ai/milestones/contract-tests"
...
check "opt-outs.snapshot reset" "gone" "$(exists .ai/milestones/opt-outs.snapshot)"
check "contract-tests reset (#901)"   "gone" "$(exists .ai/milestones/contract-tests)"
